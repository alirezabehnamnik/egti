  ...
  <div class="row">
    <div class="col-md-12">
      <div class="m-title">
        <div class="row">
          <div class="col-md-12">
             <div> مسابقات درحال برگذاری </div>
             <small style="font-size: 14px;"> ابتدا مسابقاتی که اخیرا شروع شده اند نمایش داده می شود </small>
             <a class="show-more text-center" href="{{route('tournaments_progress')}}">
               نمایش همه
             </a>
           </div>
        </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="m-title">
        <div class="row">
          <div class="col-md-12">
             <div> مسابقاتی که به زودی آغاز می شوند </div>
             <small style="font-size: 14px;"> ابتدا مسابقاتی که تاریخ شروع آنها نزدیک است نمایش داده می شوند </small>
             <a class="show-more text-center" href="{{route('tournaments_soon')}}">
               نمایش همه
             </a>
           </div>
        </div>
      ...
      <div class="m-title">
        <div class="row">
          <div class="col-md-12">
             ...
             <small style="font-size: 14px;"> ابتدا مسابقاتی که تاریخ شروع آنها نزدیک است نمایش داده می شوند </small>
             <a class="show-more text-center" href="{{route('tournaments_end')}}">
               نمایش همه
             </a>
           </div>
        </div>

...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="m-title">
        <div class="row">
          <div class="col-md-3"> مسابقات من </div>
        </div>
      </div>
      <hr>
    </div>
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-3 tournament-item text-center">
      ...
      <div class="tournament-details">
        ...
        <li>
          تاریخ شروع:
          <span class="tournament-text"> {{jdate($item->tournament->start_date)->format('Y-m-d')}} </span>
        </li>

        <li>
          تاریخ پایان:
          <span class="tournament-text"> {{jdate($item->tournament->end_date)->format('Y-m-d')}} </span>
        </li>

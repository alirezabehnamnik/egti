  ...
  <div class="row">
    ...
    <div class="col-md-6 offset-md-3">
      <div class="card-register">
        ...
        <form method="POST" action="{{ route('admin_tournament_add_save')}}" enctype="multipart/form-data">
            @csrf
            <h4 class="text-center"> <i class="fas fa-user-edit red-icon" aria-hidden="true"></i> افزودن مسابقه </h4>
            <hr>
            <br>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="tag" type="text" class="form-control @error('tag') is-invalid @enderror" name="tag" autocomplete="tag">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="entry_price" type="number" class="form-control @error('entry_price') is-invalid @enderror" name="entry_price" autocomplete="entry_price">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="max_teams" type="number" class="form-control @error('max_teams') is-invalid @enderror" name="max_teams" autocomplete="max_teams">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="player_per_team" type="number" class="form-control @error('player_per_team') is-invalid @enderror" name="player_per_team" autocomplete="player_per_team">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="prize_pool" type="number" class="form-control @error('prize_pool') is-invalid @enderror" name="prize_pool" autocomplete="prize_pool">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="fplace_reward" type="number" class="form-control @error('fplace_reward') is-invalid @enderror" name="fplace_reward" autocomplete="fplace_reward">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="splace_reward" type="number" class="form-control @error('splace_reward') is-invalid @enderror" name="splace_reward" autocomplete="splace_reward">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="tplace_reward" type="number" class="form-control @error('tplace_reward') is-invalid @enderror" name="tplace_reward" autocomplete="tplace_reward">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="foplace_reward" type="number" class="form-control @error('foplace_reward') is-invalid @enderror" name="foplace_reward" autocomplete="foplace_reward">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="fiplace_reward" type="number" class="form-control @error('fiplace_reward') is-invalid @enderror" name="fiplace_reward" autocomplete="fiplace_reward">

  ...
  <div class="row">
    <div class="col-10 offset-1">
      <div class="card-register">
        <form method="POST" action="{{ route('admin_tickets_save_create') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group row">
                <label for="standin_id" class="col-md-4 col-form-label text-md-right">{{ __('کاربر:') }} </label>

                <div class="col-md-7">

                  <select class="form-control @error('user_id') is-invalid @enderror" id="standin_id" name="user_id">
                    <option></option>
                    @foreach ($users as $v)
